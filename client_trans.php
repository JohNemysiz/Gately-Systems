...
$sql = "SELECT * FROM usertransactions WHERE UserTelephone = '$userTelephone'";
...
<head>
    ...
    <title>Transactions - Gately</title>
...
<body>
    ...
    <div class="container my-5">
        ...
        <div class="table-responsive">
                    ...
                    $sql = "SELECT * FROM usertransactions WHERE UserTelephone = '$userTelephone' LIMIT $start, $rows_per_page";
                    $result = $conn->query($sql);
                    ...
                    // Pagination
                    $sql = "SELECT COUNT(*) as total FROM usertransactions WHERE UserTelephone = '$userTelephone'";
                    $result = $conn->query($sql);
